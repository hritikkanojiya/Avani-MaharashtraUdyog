...
<body>
    <div class="content-wrapper">
        ...
        <section class="wrapper image-wrapper bg-image bg-overlay bg-overlay-400 text-white" data-image-src="../assets/img/extras/chota.jpg">
                                    ...
                                    <div class="p-10 p-md-11 p-lg-14">
                                        ...
                                        <div class="d-flex flex-row">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    <a href="mailto:support@maharashtraudyog.com" class="link-body">support@maharashtraudyog.com</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-10 p-md-11 p-lg-14">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="align-self-start justify-content-start">
                                                <h5 class="mb-1">Address</h5>
                                                <address>187, Sai Aarti, 2nd floor, Perin Nariman Street (Bazargate),
                                                    Fort, Mumbai 400001</address>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row">
                                            <div>
