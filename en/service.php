                    ...
                    <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                        <div class="offcanvas-body m-lg-auto d-flex flex-column h-100 py-10 py-md-0">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="service.php">Services</a>
                                </li>
            ...
            <div class="container pt-19 pt-md-21 pb-18 pb-md-20 text-center">
                <div class="row">
                    <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
                        ...
                        <p class="lead fs-lg px-md-3 px-lg-7 px-xl-9 px-xxl-10">Maharashtra Udyog, your trusted partner
                            for building enduring business and franchise relationships</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="wrapper bg-light">
            <div class="container pt-14 pb-12 pt-md-16 pb-md-14">
                <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                    ...
                    <div class="col-lg-5">
                        <h2 class="fs-30 text-uppercase mb-3">What We Do?</h2>
                        <h3 class="display-4 mb-5 fs-25">Guiding entrepreneurs with lucrative franchising solutions and
                            opportunities
                        </h3>
                        <p>Maharashtra Udyog is a guide to various entrepreneurs/investors on facets of franchising. It
                            provides franchising solutions, profitable opportunities, insight reviews, business ideas,
                            and partnerships. An investor can look for franchise business opportunities in the field of
                            automotive, beauty, business services, education, fashion. Other than these are food and
                            beverage, health, fitness, hotel, and retail franchise.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="wrapper bg-soft-primary">
            <div class="container py-14 pt-md-16 pt-lg-0 pb-md-10">
                <div class="row text-center">
                    <div class="col-lg-9 mx-auto">
                        <h2 class="fs-15 text-uppercase text-muted mb-3 mt-12">Our Process</h2>
                        <h3 class="display-4 mb-0 text-center px-xl-10 px-xxl-15">The Franchise Frontier: Maharashtra
                            Udyog's Contemporary Services Redefine Success.</h3>
            ...
            <div class="container py-15">
                <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-6">Success hinges on expertise, steadfast franchisee support, and
                            growth encouragement. Operational proficiency, supported by dedicated franchisees, propels
                            expansion with strategic investor involvement, ensuring sustained and robust business growth
                        </p>
                        <div class="row gy-3">
                            <div class="col-xl-6">
                                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                    <li><span><i class="uil uil-check"></i>
                                        </span>
                                        <span>Expertise, support for MaharashtraUdyog's franchisees</span>
                                    </li>
                                    <li class="mt-3"><span>
                                            <i class="uil uil-check"></i></span>
                                        <span>Operational success, MaharashtraUdyog's franchisee support</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-xl-6">
                                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                    <li><span><i class="uil uil-check"></i></span><span>Business growth through
                                            expertise, franchisee support</span></li>
                                    <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Effective
                                            operation, MaharashtraUdyog's support, growth encouragement</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-10 text-center">
                <div class="row">
                    <div class="col-md-9 col-lg-7 col-xl-7 mx-auto text-center">
                        ...
                        <h2 class="display-4 mb-3">Join hands with MaharashtraUdyog</h2>
                        <p class="lead fs-lg mb-6 px-xl-10 px-xxl-15">Maximize success by joining hands with
                            MaharashtraUdyog, unlocking endless opportunities and strategic collaborations.</p>
                    </div>
                </div>
            </div>
        </section>
