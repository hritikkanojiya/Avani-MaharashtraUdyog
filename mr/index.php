    ...
    <div class="content-wrapper">
        ...
        <section class="section-frame br-fix overflow-hidden">
            <div class="wrapper image-wrapper bg-cover bg-image bg-overlay bg-overlay-500 d-block d-md-none"
                data-image-src="../assets/img/extras/new-banner-mobile.jpeg"
                style="background-size: contain; min-height:10px" ;>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content text-center">
                <div class="modal-body pb-5">
                    <div class="row">
                        <form class="" method="post" action="https://maharashtraudyog.com/mr/index.php">
                            <div class="row gx-4">
                                <div class="col-md-8">
            ...
            <div class="row gy-6 gy-lg-0">
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="widget">
                        ...
                        <address class="pe-xl-15 pe-xxl-17">1206/1209,Navjivan Commercial Co-Op Society, Gate no.2,
