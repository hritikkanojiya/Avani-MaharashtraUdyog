                    ...
                    <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                        <div class="offcanvas-body m-lg-auto d-flex flex-column h-100 py-10 py-md-0">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="about.php">About</a>
                                </li>
            ...
            <div class="container py-14 py-md-16">
                <div class="row mb-3">
                    <div class="col-md-10 col-lg-12 col-xl-10 col-xxl-9 mx-auto text-center">
                        ...
                        <h3 class="display-4 mb-7 px-lg-19 px-xl-18">Think unique and be innovative. Make a difference
                            with MaharashtraUdyog.</h3>
                    </div>
                </div>
